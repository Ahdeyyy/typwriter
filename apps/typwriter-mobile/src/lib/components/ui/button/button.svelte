<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			...
			size: {
				default: "h-10 md:h-9 gap-1.5 rounded-full px-4 md:px-3.5 text-sm has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3 [&_svg:not([class*='size-'])]:size-4",
				...
				sm: "h-9 md:h-8 gap-1.5 rounded-full px-3.5 text-sm has-data-[icon=inline-end]:pr-2.5 has-data-[icon=inline-start]:pl-2.5 [&_svg:not([class*='size-'])]:size-3.5",
				lg: "h-11 md:h-10 gap-1.5 rounded-full px-5 text-sm has-data-[icon=inline-end]:pr-3.5 has-data-[icon=inline-start]:pl-3.5 [&_svg:not([class*='size-'])]:size-4.5",
				icon: "size-11 md:size-10 rounded-full [&_svg:not([class*='size-'])]:size-5",
				"icon-xs": "size-5 rounded-full [&_svg:not([class*='size-'])]:size-2.5",
				"icon-sm": "size-9 md:size-8 rounded-full [&_svg:not([class*='size-'])]:size-4",
				"icon-lg": "size-12 md:size-11 rounded-full [&_svg:not([class*='size-'])]:size-5.5",
			},
		},
		defaultVariants: {
			variant: "default",
